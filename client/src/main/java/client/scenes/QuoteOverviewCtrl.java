...
public class QuoteOverviewCtrl implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        colFirstName.setCellValueFactory(q -> new SimpleStringProperty(q.getValue().person.getFirstName()));
        colLastName.setCellValueFactory(q -> new SimpleStringProperty(q.getValue().person.getLastName()));
